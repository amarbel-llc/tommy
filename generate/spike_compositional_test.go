...
// fieldType maps a FieldInfo to its compositional TypeExpr. Every FieldKind
// becomes a composition; the SlicePointer flag becomes a structural Ptr.
